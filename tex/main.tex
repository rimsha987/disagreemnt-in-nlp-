...
\begin{itemize}[leftmargin=1.6em]
\item Every quantity reported above is generated by the analysis scripts and recorded, with its
source file, in the project's summary table rather than transcribed by hand.
\item The persona prompts, persona definitions and raw model responses are retained as
append-only records (180 responses at the stopping point) in the supplementary materials.
\item The full persona run of 3,675 calls was not executed because the diagnostic stop rule was
triggered.
\end{itemize}
